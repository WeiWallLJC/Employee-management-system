	...
	public create(JFrame w) {
		...
		confirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				text11=text1.replaceAll("[0-9]","");
				text12=text4.replaceAll("[0-9]","");
				text13=text7.replaceAll("[0-9]","");
				
				if(text1.isEmpty() || text2.isEmpty()|| text3.isEmpty()|| text4.isEmpty()|| text5.isEmpty()|| text6.isEmpty()|| text7.isEmpty())
					JOptionPane.showMessageDialog(null, "员工信息不完整！", "提示", 2);
				else if(!text11.isEmpty())
					JOptionPane.showMessageDialog(null, "工号应由整数组成！", "提示", 2);
				else if(!text12.isEmpty())
					JOptionPane.showMessageDialog(null, "年龄应为整数！", "提示", 2);
				else if(!text13.isEmpty())
					JOptionPane.showMessageDialog(null, "电话应由整数组成！", "提示", 2);
				else if(stfdbop.selectName(text2) || stfdbop.selectId(text1))
					JOptionPane.showMessageDialog(null, "已存在该员工信息！", "提示", 2);
				else if(!stfdbop.selectName(text2)){
					stfdbop.create(text1,text2,text3,text4,text5,text6,text7);
					JOptionPane.showMessageDialog(null, "新建信息成功！", "提示", 2);
					w.dispose();
